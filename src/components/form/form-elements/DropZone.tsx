...
const DropzoneComponent: React.FC = () => {
  const onDrop = (...params) => {
    console.log('Files dropped:', params)
    ...
    <div className="dark:hover:border-brand-500 hover:border-brand-500 cursor-pointer rounded-xl border border-dashed border-gray-300 transition dark:border-gray-700">
      ...
      >
        ...
        <div className="dz-message m-0! flex flex-col items-center">
          ...
          {/* Text Content */}
          <h4 className="text-theme-xl mb-3 text-center font-semibold text-gray-800 dark:text-white/90">
          ...
          <span className="mb-5 block w-full max-w-[290px] text-center text-sm text-gray-700 dark:text-gray-400">
            تصاویر PNG، JPG، WebP، SVG خود را اینجا بکشید و رها کنید یا مرور کنید
          </span>

          <span className="text-theme-sm text-brand-500 font-medium underline">انتخاب فایل</span>
        </div>
      </form>
    </div>
  )
