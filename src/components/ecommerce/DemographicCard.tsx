    ...
    <div className="rounded-2xl border border-gray-200 bg-white p-5 sm:p-6 dark:border-gray-800 dark:bg-white/[0.03]">
      ...
      <div className="space-y-5">
        <div className="flex items-center justify-between">
          ...
          <div className="flex w-full max-w-[140px] items-center gap-3">
            <div className="relative block h-2 w-full max-w-[100px] rounded-sm bg-gray-200 dark:bg-gray-800">
              <div className="bg-brand-500 absolute start-0 top-0 flex h-full w-[79%] items-center justify-center rounded-sm text-xs font-medium text-white"></div>
            </div>
        ...
        <div className="flex items-center justify-between">
          ...
          <div className="flex w-full max-w-[140px] items-center gap-3">
            <div className="relative block h-2 w-full max-w-[100px] rounded-sm bg-gray-200 dark:bg-gray-800">
              <div className="bg-brand-500 absolute start-0 top-0 flex h-full w-[23%] items-center justify-center rounded-sm text-xs font-medium text-white"></div>
            </div>
